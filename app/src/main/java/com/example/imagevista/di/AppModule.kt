...
import com.example.imagevista.data.repository.ImageRepositoryImplementation
import com.example.imagevista.data.repository.NetworkConnectivityObserverImplementation
...
object AppModule {
    ...
    fun provideImageRepository(
        ...
        return ImageRepositoryImplementation(apiService, database)
    }
    ...
    fun provideNetworkConnectivityObserver(
        ...
        return NetworkConnectivityObserverImplementation(context, scope)
    }
