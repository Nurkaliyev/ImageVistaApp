...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "UNSPLASH_BASE_URL", properties.getProperty("UNSPLASH_BASE_URL"))
        buildConfigField("String", "UNSPLASH_ACCESS_KEY", properties.getProperty("UNSPLASH_ACCESS_KEY"))
        buildConfigField("String", "UNSPLASH_SECRET_KEY", properties.getProperty("UNSPLASH_SECRET_KEY"))
    }
